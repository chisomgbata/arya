...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('WomenHistories', function (Blueprint $table) {
            ...
            $table->dateTime('First_menstrual_period', 7)->nullable();
            ...
            $table->dateTime('Expected_delivery_date', 7)->nullable();
            ...
            $table->dateTime('Last_delivery', 7)->nullable();
            $table->dateTime('Last_menstrual_period', 7)->nullable();
            ...
            $table->primary(['Id'], 'pk_womenhistories');
        });
    }
